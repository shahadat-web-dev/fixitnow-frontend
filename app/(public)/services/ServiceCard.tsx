  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4">
          <h3 className="line-clamp-1 text-sm font-bold text-[#101720]">
            {service.service.name}
          </h3>

          <p className="mt-1 line-clamp-2 text-xs text-[#7C8798]">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <span className="line-clamp-1 text-xs text-[#7C8798]">
          ...
          <div className="mt-3 flex items-center justify-between">
            <div className="flex items-center gap-1 text-xs">
              ...
              <span className="font-semibold text-[#101720]">
                {rating.toFixed(1)}
              </span>
          ...
          <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-3">
            <div>
              ...
              <p className="text-base font-bold text-[#101720]">
                ৳{service.price}
              </p>
            </div>
